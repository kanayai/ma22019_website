...
library(sf)
library(ggplot2)
CANADA <- read_sf("data/shapefiles/gadm41_CAN_1.shp")
CANADA <- st_simplify(CANADA, dTolerance = 5000)
CANPlot1 <- ggplot(data = CANADA) +
    theme_bw() +
    geom_sf()
CANPlot2 <- CANPlot1 + coord_sf(crs = st_crs(3347))

NORWAY <- read_sf("data/shapefiles/gadm41_NOR_1.shp")
NORWAY <- st_simplify(NORWAY, dTolerance = 2000)
NORPlot1 <- ggplot(data = NORWAY) +
    theme_bw() +
    geom_sf()
