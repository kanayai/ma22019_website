...
Let's look at an example</br>**`r colorize("-> Quarto Document WildFires.qmd")`**



**But**: We may not always see the structure clearly</br>**`r colorize("-> Quarto Document Tornadoes.qmd")`**
...
**`r colorize("-> Quarto Document WildFires.qmd")`**
...
This correction is available in the spatstat R package.</br>**`r colorize("-> Quarto Document WildFires.qmd")`**

## Analysis of Tornadoes

Let's consider a second example</br>**`r colorize("-> Quarto Document Tornadoes.qmd")`**
...
Let's visualize population density for the different boroughs.</br>**`r colorize("-> Quarto Document")`**
...
</br>**`r colorize("-> Quarto Document Tornadoes.qmd")`**
