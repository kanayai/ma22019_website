# MA22019: Tutor Status Checker
# Checks if tutors have created their Lab 00 repo and if they have pushed commits.
...
# Smart Path Finding
possible_paths <- c(
    "_admin/rosters/roster_tutors.csv", # From Project Root
    "rosters/roster_tutors.csv", # From _admin/ folder
    "../_admin/rosters/roster_tutors.csv" # Just in case
)
...
message(glue("🔍 Checking status for {nrow(roster)} tutors..."))
