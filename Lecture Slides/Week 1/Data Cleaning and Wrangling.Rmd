...
knitr::include_graphics("DataCleaning.jpg")
```
...
## River Flow Data - Loading the Data {.build}
...
## Converting Variables III {.build}
...
## Why do we convert to a date object? {.build}
...
## River Flow Data - Converting variables {.build}
...
knitr::include_graphics("pipeline2.jpg")
```

## Why is data wrangling useful? {.build}
