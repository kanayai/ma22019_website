...
## Types of Spatial Data II {.build}
...
## Creating maps with ggspatial{.build}
...
## Inverse Distance Weighting {.build}
...
## Effect of the power parameter {.build}
