...
```{r, echo=TRUE}
text_Hesse <- readLines( "Hesse quote.txt" )
text_Hesse
```
...
## Visualizing word frequency {.build}
...
## Comparison using term frequency {.build}
