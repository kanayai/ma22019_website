...
*   **Your Use:** Think of it as your **Sandbox**. Want to test some code from a lecture? Want to try a new package? create a script in `practice/my_experiments.R`! It's the one place where you can be messy without breaking anything important.
