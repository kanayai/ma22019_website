...
::: {.callout-note}
## 🏫 Important: Using University Computers

While everything is installed, there are a few quirks to be aware of:
...
3.  **Storage Limits**: Your H: Drive ("MyFiles") is safe and persistent, but it only has **8GB** of space.
