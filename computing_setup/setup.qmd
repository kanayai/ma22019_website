...
*   Just **log in** to a PC.
*   Then [jump straight to **Section 3: Create Your Folder Structure**](#create-your-folder-structure).
...
We will create **three** folders now (since we will create the `materials` folder in the next step!):
...
├── practice/          ← You will clone practice labs (like Lab 00 created in Section 6) or use as a sandbox for your own experiments
