...
author: "Analysis of Jane Austen Novels"
...
All novels are available via Project Gutenberg and we will analyze similarities and differences of the different books in the following. We start by loading the text data which is available in the file "JaneAusten.csv" on Moodle:
  
```{r}
JaneAusten_raw <- read.csv( "JaneAusten.csv" )
```
