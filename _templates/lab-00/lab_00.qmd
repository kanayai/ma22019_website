...
[AI-agent: add explanation of what the YAML header is (the one in between the '---' lines at the top of the file). also add the naming conventions somwhere,. also something again about the Source mode . also a good recomendation on how often to Render the document. be brief and refer to releavant page in the computing_setup]
